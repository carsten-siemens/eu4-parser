...
var FileUtil = class _FileUtil {
  ...
  static #readFileStartAsString(filePath, byteCount, encoding) {
    let fd = void 0;
    try {
      fd = import_fs.default.openSync(filePath, "r");
      const buffer = Buffer.alloc(byteCount);
      const bytesRead = import_fs.default.readSync(fd, buffer, 0, byteCount);
...
var ParserManager = class {
  ...
  #parseZipFile(filePath, encoding) {
    let o = {};
    const zipEntries = new import_adm_zip.default(filePath).getEntries();
